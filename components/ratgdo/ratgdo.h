...
namespace ratgdo {
    ...
    */
    ...
    public:
        ...
        uint8_t tx_rolling_code[CODE_LENGTH];
        uint8_t rx_rolling_code[CODE_LENGTH];
        ...
        void set_remote_id(uint64_t remote_id) { this->remote_id_ = remote_id_ & 0xffffff; }; // not sure how large remote_id can be, assuming not more than 24 bits
