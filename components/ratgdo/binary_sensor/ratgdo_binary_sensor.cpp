...
namespace ratgdo {
    ...
    void RATGDOBinarySensor::setup()
    {
        ...
        if (this->binary_sensor_type_ == SensorType::RATGDO_SENSOR_MOTION) {
            this->get_parent()->subscribe_motion_state([=](MotionState state){
            ...
            this->get_parent()->subscribe_obstruction_state([=](ObstructionState state){
